...
public class VentanaEstudiante extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingrese Carrera");

        jLabel3.setText("Ingrese Correo");

        jLabel4.setText("Ingrese Ciclo");

        jLabel5.setText("Ingrese Año de nacimiento");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        estudianteControl.crearEstudiante(args);
    ...
    private void actualizarTabla(){
        ...
        encabezado[2]="Correo";
        encabezado[3]="Ciclo";
        encabezado[4]="Año de Nacimiento";
        
        var datos=new Object[this.estudianteControl.ListarEstudiante().size()][5];
        var i=0;
        for(var estudiante:this.estudianteControl.ListarEstudiante()){
            datos[i][0]=estudiante.getNombre();
            datos[i][1]=estudiante.getCarrera(); 
            datos[i][2]=estudiante.getCorreo();
            datos[i][3]=estudiante.getCiclo();
            datos[i][4]=estudiante.getAnionacimiento();
            i++;
        }
